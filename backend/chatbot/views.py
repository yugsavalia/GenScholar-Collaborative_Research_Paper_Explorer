...
def ask_question(request):
    ...
    try:
        ...
        # Check user role - REVIEWER cannot use AI ChatBot
        try:
        ...
        # We save the full "/ai ..." message for consistency
        # It's linked to the user who asked.
        ...
        # --- 3. Save AI's Answer ---
        # It's also linked to the user who asked, keeping it private.
        ...
        # The JavaScript will use this to update the chat window
        return JsonResponse({
            'status': 'ok',
